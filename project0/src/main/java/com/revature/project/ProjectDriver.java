...
public class ProjectDriver {
	...
	private static void viewMyAccounts(User user) {
		List<Account> accounts = user.getAccounts();
		System.out.println("Your Accounts:");
		System.out.println(accounts);
	}
	
	private static void viewMyBeneficiaries(User user) {
		List<Beneficiary> beneficiary = user.getBeneficiary();
